...
describe('AI proposal composer request mapping', () => {
  ...
  it('maps every visible planning control into the Stage 6 request', () => {
    ...
    expect(input).toMatchObject({
      ...
      experienceLevel: 'advanced', planIntensity: 'ambitious', preferredLanguage: 'en', locale: 'en',
    })
  ...
  it('maps savings separately from budget and follows the active UI language', () => {
    ...
    expect(input).toMatchObject({ monthlyBudget: null, currency: 'MXN', experienceLevel: 'beginner', planIntensity: 'light', preferredLanguage: 'es' })
